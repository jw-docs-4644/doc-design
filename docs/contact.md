...
<div style="margin-bottom: 1rem;">
    ...
    <textarea id="message" name="message" required rows="5" style="width: 100%; padding: 0.5rem; border: 1px solid #ccc; border-radius: 4px;"></textarea>
  </div>

  <button type="submit" style="padding: 0.5rem 1rem; background-color: #007bff; color: white; border: none; border-radius: 4px; cursor: pointer;">Send</button>

</form>

---

- [LinkedIn](https://www.linkedin.com/in/joshua-welsh-5116a027)
